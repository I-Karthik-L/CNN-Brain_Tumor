...
def load_model():
    ...
    # custom_objects tells Keras exactly what 'preprocess_input' refers to,
    # instead of trying to re-import it from the internal module path that
    # was recorded at save time (which can differ between Keras versions
    # and break across environments -- exactly what was happening here).
    # safe_mode=False is still needed since the model contains a Lambda
    # layer; safe here since we trained and uploaded this model ourselves.
